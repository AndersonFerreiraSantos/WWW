		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<p class="text-center">Controle de estoque Xerox</p>
						<form action="config_validacao_usuario.php" method="POST" class="login-form">
	            ...
	            <div class="form-group">
	            	<button type="submit" class="btn form-control btn-primary rounded submit px-3">CONFIRMAR</button>
	            </div>
	          </form>
